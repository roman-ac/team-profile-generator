// creating generateHTML function
        ...
        <div class="container">
            <div class="row">
                <div class="col">
                    <h2>Managers</h2>
                    <hr>
                    <div class="card" style="width: 285px;"><div class="card-header">${manager.role}</div>
                ...
                <div class="col">
                    <h2>Engineers</h2>
                    <hr>
                    <div class="card" style="width: 285px;"><div class="card-header">${engineer.role}</div>
                    <ul class="list-group list-group-flush">
                ...
                <div class="col">
                    <h2>Interns</h2>
                    <hr>
                    <div class="card" style="width: 285px;"><div class="card-header">${intern.role}</div>
                    <ul class="list-group list-group-flush">
